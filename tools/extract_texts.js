...
// Konjugations-/Tabellenzeilen: r[3] = antippbare Audio-Phrase (z. B. „я читаю", „он был")
const GL = X.GRAM_LEHR || {};
for (const k in GL) (GL[k].rows || []).forEach(r => { if (r[3]) texts.add(r[3].trim()); });
